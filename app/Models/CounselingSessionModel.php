...
class CounselingSessionModel extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'session_date', 'status', 'notes', 'follow_up', 'is_urgent'
    ];
    ...
    public function getSessionsWithDetails($limit = null)
    {
        ...
        $builder->select('cs.*, s.name as student_name, s.nis, s.class, c.name as counselor_name, cat.name as category_name, cat.color as category_color');
    ...
    {
        return $this->getSessionsWithDetails()->where('cs.student_id', $studentId);
    }

    public function getSessionsByCounselor($counselorId)
    {
        return $this->getSessionsWithDetails()->where('cs.counselor_id', $counselorId);
    }
